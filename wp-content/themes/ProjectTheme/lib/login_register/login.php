...
<div id="main_wrapper">
		<div id="main" class="wrapper-register"><div class="padd10">
                ...
                <div class="box_content">
					...
					<h3 class="h3-name"><?php printf(__("Retrieve Password - %s",'ProjectTheme'), get_bloginfo('name')); ?></h3>
...
<div id="main_wrapper">
		<div id="main" class="wrapper-register"><div class="padd10">
            ...
            <div class="my_box4">
				...
				<h3 class="h3-name"><?php printf(__("Login - %s",'ProjectTheme'), get_bloginfo('name')); ?></h3>

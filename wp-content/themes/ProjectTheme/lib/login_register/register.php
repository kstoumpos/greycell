...
<div id="main_wrapper">
		<div id="main" class="wrapper-register"><div class="padd10">
				...
				<h3 class="h3-name"><?php printf(__("Register - %s",'ProjectTheme'), get_bloginfo('name')); ?></h3>
                ...
                <div class="box_content">
						  ...
						  <input type="hidden" name="action" value="register" />
							...
							<input type="radio" class="do_input_radio" name="user_tp" id="user_tp" value="service_provider" checked="checked" /> <?php _e('Service Provider','ProjectTheme'); ?><br/>
                            <input type="radio" class="do_input_radio" name="user_tp" id="user_tp" value="business_owner" /> <?php _e('Service Contractor','ProjectTheme'); ?><br/>
							</p>
						...
						<?php printf(__("Already have an account ? <a href='%s' class='link-man-1'>Login here</a> or <a href='%s' class='link-man-1'>Recover your password</a>.","ProjectTheme"), site_url().'/wp-login.php', 

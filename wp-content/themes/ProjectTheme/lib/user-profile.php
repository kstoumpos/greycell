				...
				<?php } ?>
                        ...
                        <?php
                          ...
                          <?php endif;
													...
													<a href="<?php echo ProjectTheme_get_priv_mess_page_url('send', '', '&uid='.$uid); ?>"><?php echo __('Contact User','ProjectTheme'); ?></a>
...
?>
               ...
               <span class="sml_ltrs"> [<a href="<?php echo esc_url( home_url() )  ?>?p_action=user_feedback&post_author=<?php echo $uid; ?>"><?php _e('See All Feedback','ProjectTheme'); ?></a>]</span>
               </div>
...
<div class="clear10"></div>
            	...
            	<div class="box_title"><?php _e("User Latest Won Projects",'ProjectTheme'); ?></div>

...
echo $args['before_widget'];
		...
		if(empty($limit) || !is_numeric($limit)) $limit = 5;
				 ...
				 ?>
                     ...
                     <?php projectTheme_get_post_smm(); ?>
                     
                     
                     <?php endforeach; 


			echo '<div class="see-all-freelancers"><a href="'.get_permalink(get_option('ProjectTheme_advanced_search_page_id')).'">'.__('Search For More Projects','ProjectTheme').'</a></div>';

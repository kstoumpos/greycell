...
<div id='search-box'>
<form action='<?php echo site_url(); ?>' id='search-form' method='get' target='_top'>
<input type="hidden" value='<?php echo get_option('ProjectTheme_advanced_search_page_id') ?>' name="page_id" />
<input id='search-text' name='term' placeholder='<?php _e('Start search...','ProjectTheme') ?>' type='text'/>
<button id='search-button' type='submit'>                     
<span><?php _e('Search Projects','ProjectTheme') ?></span>
</button>
</form>
</div>

...
<p><?php echo strip_tags(get_the_term_list( $PID_PID, 'project_skill', '', ', ', '' )); ?></p>
</li>
       ...
       <p id='proposal_btn_p'>
        ...
        <div class="avatar-op-wrap">
        	...
        	<div class="avatar-op-list">
            		<ul>
                    	<li><a class="avatar-posted-by-username" href="<?php echo esc_url( home_url() )  ?>/?p_action=user_profile&post_author=<?php echo $current_user->ID; ?>"><?php echo $current_user->user_login; ?></a></li>
                    	<li><?php echo ProjectTheme_project_get_star_rating2($current_user->ID); ?></li>
                        <li><a href="<?php echo ProjectTheme_get_user_feedback_link($current_user->ID); ?>"><?php _e('View User Feedback','ProjectTheme'); ?></a></li>
                    </ul>
            </div>
        ...
        <ul class="other-dets other-dets2">
                ...
                <?php
					...
					$has_created 	= projectTheme_get_total_number_of_created_Projects($current_user->ID);
					$has_closed 	= projectTheme_get_total_number_of_closed_Projects($current_user->ID);
					$has_rated 		= projectTheme_get_total_number_of_rated_Projects($current_user->ID);
            	...
            	<br/><br/>
               <a href="<?php echo esc_url( home_url() )  ?>/?p_action=user_profile&post_author=<?php echo $current_user->ID; ?>"><?php _e('See More Projects by this user','ProjectTheme'); ?></a><br/>
  ...
  <?php endif; ?>
	...
	<li class="widget-container widget_text" id="ad-other-details">
        ...
        <?php endif; ?>
			...
			<a href="<?php echo home_url(); ?>/?p_action=edit_project&pid=<?php the_ID(); ?>" class="nice_link"><?php _e("Edit",'ProjectTheme'); ?></a>
			<a href="<?php echo home_url(); ?>/?p_action=repost_project&pid=<?php the_ID(); ?>" class="nice_link"><?php _e("Repost",'ProjectTheme'); ?></a>

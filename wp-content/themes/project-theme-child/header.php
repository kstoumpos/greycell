            ...
            jQuery(document).ready(function(){
                jQuery('.expiration_project_p').each(function(index) {
                    ...
                    jQuery(this).countdown({
                        ...
                        labels1: ['Χρόνος', 'Μήνας', 'Εβδομάδα', 'Μέρα ', 'Ώρα', 'Λεπτό ','Δευτερόλεπτο'],
                    });
                });

                jQuery("#cssmenu2").menumaker({
                title: "<?php _e('Categories','ProjectTheme'); ?>",
                format: "multitoggle"
                });
            });
        })(jQuery);
			...
			<div class="top-bar-bg">
				<div class="top-bar">
                    ...
                    <script src="<?php   echo get_template_directory_uri() ?>/js/ace-responsive-menu.js" type="text/javascript"></script>
                        ...
                        <?php //add_action( 'wp_enqueue_scripts', 'aceResponsiveOverride' );
                        // function aceResponsiveOverride() {
                        //     wp_dequeue_script('ace-responsive-menu');
                        //     wp_enqueue_script('ace-responsive-menu', get_template_directory_uri().'/js/ace-responsive-menu.js', array('jQuery'));
                        // } ?>

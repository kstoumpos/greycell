...
<div class="page_heading_me">
    <div class="page_heading_me_inner">
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
            <div class="mm_inn">
                <?php printf(__("Project Workspace - #%s", "ProjectTheme"), $pid); ?>
            </div>
        </div>
    </div>
</div>
...
<div id="main_wrapper">
    <div id="main" class="wrapper">
	    <div class="account-main-area col-xs-12 col-sm-8 col-md-8 col-lg-8">
            <div class="my_box3">
            	<div class="padd10">
                    <div class="box_content">
                        ...
                        ProjectTheme_get_user_profile_link($owner->ID) ,$owner->user_login); ?> <br/>
            ...
            <div class="my_box3 zg_small_space_box">
                <div class="padd10 wk-cnt1">
                    <div class="dt_space">
                        <?php echo date_i18n('d-M-Y H:i:s', get_post_meta($project,'closed_date',true) ) ?>
                    </div>

                    <div class="avatar_icon">
                        <img width="48" src="<?php echo get_template_directory_uri(); ?>/images/info_icon2.png" />
                    </div>
                    <div class="cnd_space">
                        <?php _e('Work has started. Freelancer begins work on the project.','ProjectTheme') ?>
                    </div>
            ...
            <?php
                ...
                if(count($r) > 0) {
                    ...
                    <div class="my_box3 zg_small_space_box <?php if($row->owner == $current_user->ID) echo 'cl_001' ?>">
                        <div class="padd10 wk-cnt1">
                            <div class="dt_space"><?php echo date_i18n('d-M-Y H:i:s', $row->datemade ) ?></div>
                                <div class="avatar_icon">
                                    <img width="48" src="<?php echo ProjectTheme_get_avatar($row->owner,48, 48) ?>" class="avs-11" /><br/>
                                    <?php echo '<a href="'.ProjectTheme_get_user_profile_link($msowner->ID).'">'.$msowner->user_login.'</a>' ?>
                                </div>
                                <div class="cnd_space">
                                    <?php echo strip_tags($row->content,'<br>') ?>
                                </div>
            ...
            if($mark_coder_delivered == 1){
                ...
                <div class="my_box3">
                    <div class="padd10 wk-cnt1">
                        <div class="dt_space">
                            <?php echo date_i18n('d-M-Y H:i:s', get_post_meta($project,'mark_coder_delivered_date',true) ) ?>
                        </div>
                        ...
                        <div class="cnd_space">
                            <?php _e('Project has been completed by the freelancer. Waiting on the project owner to confirm the work.','ProjectTheme') ?>
                        </div>
            ...
            if($mark_seller_accepted == 1){
                ...
                <div class="my_box3">
                    <div class="padd10 wk-cnt1">
                        <div class="dt_space">
                            <?php echo date_i18n('d-M-Y H:i:s', get_post_meta($project,'mark_seller_accepted_date',true) ) ?>
                        </div>
                        ...
                        <div class="cnd_space">
                            <?php _e('Project is now ended. The work has been approved by the project owner.','ProjectTheme') ?>
                        </div>
            ...
            <div class="my_box3">
                <div class="padd10 wk-cnt1">
                    <form method="post">
                        <input name="tm" value="<?php echo current_time('timestamp',0) ?>" type="hidden" />
